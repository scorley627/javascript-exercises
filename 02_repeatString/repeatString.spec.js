...
describe('repeatString', () => {
  ...
  test('repeats the string a random amount of times', function () {
    /* The number is generated by using Math.random to get a value from between
      0 to 1, when this is multiplied by 1000 and rounded down with Math.floor
      it equals a number between 0 to 999 (this number will change everytime you
      run the test).

      DO NOT use Math.floor(Math.random() * 1000) in your code, this test
      generates a random number, then passes it into your code with a function
      parameter. If this doesn't make sense, you should go read about functions
      here:
